...
with st.sidebar:
    ...
    st.markdown("<h1 style='text-align: center;'>Crop Recommedation System using Random Forest Algorithm</h1>", unsafe_allow_html= True)
    st.markdown("""
        <h4 style='text-align: left;'>
        This simple crop recommender system was trained using Random Forest Algorithm in giving
        recommendations to farmers the best and suitable crop based on an Crop 
        ...
        By inputing N(Nitrogen), P(Fosfor), K(Kalium), and pH(Keasaman tanah) values based on soil conditions, 
...
with col5:
  ...
  # Update logic based on selected location (assuming n_input, p_input, k_input, and temp_input are defined elsewhere)
  if location == 'Java':
